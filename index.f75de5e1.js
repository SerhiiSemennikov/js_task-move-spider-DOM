...
wall.addEventListener("click", (e)=>{
    /* wall.onclick = function () { */ const wallCoords = wall.getBoundingClientRect();
    const spiderCoords = {
        top: event.clientY - wallCoords.top - wall.clientTop - spider.clientHeight / 2,
        left: event.clientX - wallCoords.left - wall.clientLeft - spider.clientWidth / 2
    };
